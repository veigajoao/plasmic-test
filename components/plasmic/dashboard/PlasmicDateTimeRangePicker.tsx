...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: i4wrxtx9Ahtw/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__lhBwQ
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__lhBwQ__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__rMzYs
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__rMzYs__datePickerPopup"],
                  showTime: false
                };
